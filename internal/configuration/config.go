...
type Config struct {
	...
	ResponseHeaderNames     CommaSeparatedList   `long:"response-header-names" env:"RESPONSE_HEADER_NAMES" default:"X-Forwarded-User" description:"Response headers containing the authenticated user's username"`
